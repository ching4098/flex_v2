import 'package:flex_v2/Animations/FadeAnimation.dart';
...
class _MyAppState extends State<MyApp> with TickerProviderStateMixin{
  ...
  void initState() {
    ...
    _scale2Animation = Tween<double>(
      ...
      if (status == AnimationStatus.completed) {
        Navigator.push(context, PageTransition(type: PageTransitionType.fade, child: new RootPage(auth: new Auth())));
      }
    });
  }
            ...
            Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  SizedBox(height: 15,),
                  FadeAnimation(1.3, Text("Get started with Flex today. \n A new way to flex up your life <3",
